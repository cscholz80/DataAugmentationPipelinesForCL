"""Setup-script for dataaugmentationpipelinesforcl package."""
from setuptools import setup, find_packages
import os
import re

PACKAGE_NAME = 'dataaugmentationpipelinesforcl'  # name used by PIP
IMPORT_NAME = 'dataaugmentationpipelinesforcl'  # name used for imports
NAMESPACE = ""
...
requirements = {
    'install': [
        r for r in requirements_install if r.startswith('-r ')
    ],
    'test': [  # testing
        'nose',
        'coverage',
    ...
    'dev': [
        r for r in requirements_dev if r.startswith('-r ')
    ],
}

URLS = {
    'JIRA': 'http://applik-84.iwes.fraunhofer.de/',  # TODO: add link to project
    'GITLAB': 'https://gitlab.cc-asp.fraunhofer.de/iee_oe224/DataAugmentationPipelinesForCL',  # TODO add link for this to coookiecutter props?
